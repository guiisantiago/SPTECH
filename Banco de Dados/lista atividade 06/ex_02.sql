...
INSERT INTO Cliente (nome, email, endereco, indicadorCliente) VALUES
...
FROM Cliente CI
JOIN Cliente C ON CI.indicadorCliente = C.idCliente
WHERE C.nome = 'Pedro';

SELECT C1.nome AS Cliente, C2.nome AS ClienteIndicador, V.total, P.nome AS Produto
FROM Cliente C1
LEFT JOIN Cliente C2 ON C1.indicadorCliente = C2.idCliente
